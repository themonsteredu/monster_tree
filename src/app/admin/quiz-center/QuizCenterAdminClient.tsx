...
const TEMPLATE_ROWS: string[][] = [
  ["수학", "중1", "-3 + 5 의 값은?", "-8", "-2", "2", "8", "3", "5에서 3을 빼면 2가 돼요.", "쉬움"],
  ["수학", "초3", "7 × 8 의 값은?", "54", "56", "48", "64", "2", "7단을 외우면 7×8=56 이에요.", "쉬움"],
  ["상식", "전체", "대한민국의 수도는?", "서울", "부산", "대구", "인천", "1", "대한민국의 수도는 서울이에요.", "쉬움"],
  ["상식", "전체", "1기압에서 물이 끓는 온도는 섭씨 몇 도?", "0도", "50도", "100도", "200도", "3", "1기압에서 물은 100도에서 끓어요.", "쉬움"],
  ["넌센스", "전체", "세상에서 가장 뜨거운 과일은?", "사과", "귤", "천도복숭아", "바나나", "3", "천(1000)도 복숭아라서요.", "쉬움"],
];
    ...
    <Modal title="📋 엑셀/시트 업로드" onClose={onClose}>
      <div className="space-y-3">
        <div className="text-xs text-gray-600 leading-relaxed bg-gray-50 border border-gray-100 rounded-lg p-3">
          ...
          <p className="mt-1">
            <b>「📥 양식 다운로드」</b> 로 받은 양식을 그대로 쓰면 돼요. 머리글(첫 줄):{" "}
            <code>분류, 학년, 문제, 보기1~4, 정답</code> (선택: <code>해설, 난이도</code>).
            영문 머리글(<code>category, grade …</code>)도 인식해요.
          </p>
          <ul className="mt-1 list-disc list-inside space-y-0.5">
            ...
            <li>
              <b>학년</b>: 수학은 초3~중3, 상식·넌센스는 전체(비워도 됨)
            </li>
            <li>
              <b>정답</b>: 정답인 보기 번호 1~4
            </li>
            <li>
              <b>난이도</b>: 쉬움 / 보통 / 어려움 (비우면 보통)
            </li>
          </ul>
        </div>
