...
export const FOREST_SCENE_LAYOUT: Required<Pick<SceneLayout, "tree" | "avatar" | "monster">> = {
...
export function resolveYardScene(saved: SceneLayout | null, forest: boolean): Required<Pick<SceneLayout, "tree" | "avatar" | "monster">> {
